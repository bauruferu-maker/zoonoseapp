...
export default function HomeScreen() {
  ...
  return (
    <ScrollView style={s.container} contentContainerStyle={s.content}>
      ...
      <TouchableOpacity style={s.secondaryBtn} onPress={() => router.push('/(app)/properties')}>
        <MaterialIcons name="home-work" size={20} color="#006B3F" />
        <Text style={s.secondaryBtnText}>Consultar Imoveis do Setor</Text>
      </TouchableOpacity>
...
const s = StyleSheet.create({
  ...
  secondaryBtn: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: '#ecfdf5', borderWidth: 1, borderColor: '#a7f3d0', borderRadius: 12, padding: 14, marginBottom: 20 },
  secondaryBtnText: { color: '#065f46', fontWeight: '700', fontSize: 14 },
