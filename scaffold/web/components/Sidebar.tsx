...
const NAV: NavItem[] = [
  ...
  { href: '/dashboard/properties', label: 'Imóveis', icon: <IconBuilding size={18} />, roles: ['manager', 'coordinator', 'admin'] },
  { href: '/dashboard/agents', label: 'Agentes', icon: <IconUsers size={18} />, roles: ['manager', 'admin'] },
  { href: '/dashboard/routes', label: 'Fila de Trabalho', icon: <IconListTodo size={18} />, roles: ['manager', 'coordinator', 'admin'] },
  { href: '/dashboard/reports', label: 'Relatórios', icon: <IconTrendingUp size={18} />, roles: ['manager', 'admin'] },
